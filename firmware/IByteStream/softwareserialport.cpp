...
int SoftwareSerialPort::available()
{
    return (this->m_serialPort->available());
}

int SoftwareSerialPort::readUntil(char readUntilByte, char *out, size_t maximumReadSize)
{
    return this->readUntil(&readUntilByte, out, maximumReadSize);
}

int SoftwareSerialPort::readUntil(const char *readUntilString, char *out, size_t maximumReadSize)
{
    if (!readUntilString) {
        return 0;
    }
...
int SoftwareSerialPort::readLine(char *out, size_t maximumReadSize)
{
...
void SoftwareSerialPort::setEnabled(bool enabled) 
{ 
    this->m_isEnabled = enabled; 
}

int SoftwareSerialPort::rxPin() const 
{ 
    return this->m_rxPin; 
}

int SoftwareSerialPort::txPin() const 
{ 
    return this->m_txPin; 
}

long long SoftwareSerialPort::baudRate() const
{
    return this->m_baudRate;
}

long long SoftwareSerialPort::timeout() const
{
    return this->m_timeout;
}

bool SoftwareSerialPort::serialPortIsNull() const
{
    return this->m_serialPort == nullptr;
}

bool SoftwareSerialPort::isEnabled() const 
{ 
...
const char *SoftwareSerialPort::lineEnding() const
{
    return this->m_lineEnding;
}

void SoftwareSerialPort::print(const char *stringToPrint)
{
    this->m_serialPort->print(stringToPrint);
}

void SoftwareSerialPort::print(char *stringToPrint)
{
    this->m_serialPort->print(stringToPrint);
}

void SoftwareSerialPort::print(char charToPrint)
{
    this->m_serialPort->print(charToPrint);
}

void SoftwareSerialPort::print(short shortToPrint)
{
    this->m_serialPort->print(shortToPrint);
}

void SoftwareSerialPort::print(int intToPrint)
{
    this->m_serialPort->print(intToPrint);
}

void SoftwareSerialPort::print(bool boolToPrint)
{
    this->m_serialPort->print(boolToPrint);
}

void SoftwareSerialPort::println(const char *stringToPrint)
{
...
void SoftwareSerialPort::println(char *stringToPrint)
{
    char *temp = new char[SERIAL_PORT_BUFFER_MAX];
    strncpy(temp, stringToPrint);
    strncpy(temp, this->m_lineEnding);
...
void SoftwareSerialPort::println(char charToPrint)
{
    char *temp = new char[SERIAL_PORT_BUFFER_MAX];
    temp[0] = charToPrint;
    temp[1] = '\0';
...
void SoftwareSerialPort::println(short shortToPrint)
{
    char *temp = new char[SERIAL_PORT_BUFFER_MAX];
...
void SoftwareSerialPort::println(int intToPrint)
{
    char *temp = new char[SERIAL_PORT_BUFFER_MAX];
...
void SoftwareSerialPort::println(bool boolToPrint)
{
    char *temp = new char[SERIAL_PORT_BUFFER_MAX];
...
IByteStream &SoftwareSerialPort::operator<<(const char *rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}

IByteStream &SoftwareSerialPort::operator<<(char *rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}
...
IByteStream &SoftwareSerialPort::operator<<(short rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}

IByteStream &SoftwareSerialPort::operator<<(int rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}

IByteStream &SoftwareSerialPort::operator<<(unsigned long rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}

IByteStream &SoftwareSerialPort::operator<<(bool rhs)
{
    this->m_serialPort->print(rhs);
    return *this;
}

void SoftwareSerialPort::syncStringListener()
{
...
void SoftwareSerialPort::addToStringBuilderQueue(char byte)
{
